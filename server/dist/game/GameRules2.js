...
(function (CardPatternType2) {
    ...
    // 炸弹牌型
    CardPatternType2[CardPatternType2["BOMB_SMALL"] = 20] = "BOMB_SMALL";
    CardPatternType2[CardPatternType2["BOMB_MEDIUM_SMALL"] = 21] = "BOMB_MEDIUM_SMALL";
    CardPatternType2[CardPatternType2["BOMB_MEDIUM"] = 22] = "BOMB_MEDIUM";
    CardPatternType2[CardPatternType2["BOMB_MEDIUM_LARGE"] = 23] = "BOMB_MEDIUM_LARGE";
    CardPatternType2[CardPatternType2["BOMB_LARGE"] = 24] = "BOMB_LARGE";
    // 王炸牌型
    CardPatternType2[CardPatternType2["ROCKET_SMALL"] = 30] = "ROCKET_SMALL";
    CardPatternType2[CardPatternType2["ROCKET_MEDIUM_SMALL"] = 31] = "ROCKET_MEDIUM_SMALL";
    CardPatternType2[CardPatternType2["ROCKET_MEDIUM"] = 32] = "ROCKET_MEDIUM";
    CardPatternType2[CardPatternType2["ROCKET_MEDIUM_LARGE"] = 33] = "ROCKET_MEDIUM_LARGE";
    CardPatternType2[CardPatternType2["ROCKET_LARGE"] = 34] = "ROCKET_LARGE";
...
class GameRules2 {
    ...
    static recognizeRocket(cards) {
        let jokerCount = 0;
        for (const card of cards) {
            if (card.rank === types_1.CardRank.SMALL_JOKER || card.rank === types_1.CardRank.BIG_JOKER) {
                jokerCount++;
            }
        }
        // 所有牌都是王
    ...
    static recognizeBomb(cards, _countValues, rankCounts) {
        ...
        const bombType = (() => {
            if (cardCount >= 11)
                return CardPatternType2.BOMB_LARGE;
            if (cardCount >= 9)
                return CardPatternType2.BOMB_MEDIUM_LARGE;
            if (cardCount >= 7)
                return CardPatternType2.BOMB_MEDIUM;
            if (cardCount >= 5)
                return CardPatternType2.BOMB_MEDIUM_SMALL;
    ...
    static addRocketMoves(hand, lastMove, playerId, moves) {
        const jokerCards = hand.cards.filter(c => c.rank === types_1.CardRank.SMALL_JOKER || c.rank === types_1.CardRank.BIG_JOKER);
